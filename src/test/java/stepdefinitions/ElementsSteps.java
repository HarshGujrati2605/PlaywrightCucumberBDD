...
public class ElementsSteps {
    ...
    @When("user clicks {string} navbar option in Elements page")
    public void clickElementNavBar(String navbarOption) {
        elementsPage.clickElementNavBar(navbarOption);
    }

    @When("user enters {string} in Full Name Edit box in Elements page")
    ...
    @Then("verify that {string} checkbox selected text is displayed in Check Box section in Elements page")
    ...
    @Then("verify that {string} is first column header in Web Tables section in Elements page")
    ...
    @When("user performs {string} click in Buttons section in Elements page")
    public void performClick(String clickType) {
        elementsPage.performClick(clickType);
    }

    @Then("user verifies {string} click success message in Buttons section in Elements page")
    ...
    @Then("user uploads {string} file in Upload and Download section in Elements page")
    public void performFileUpload(String fileName) {
        elementsPage.performFileUpload(fileName);
    }

    @Then("verify {string} is uploaded successfully in Upload and Download section in Elements page")
